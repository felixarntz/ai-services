...
// See `@wordpress/components/src/utils/colors-values.js`.
const COLORS = {
	theme: {
		accent: `var(--wp-components-color-accent, var(--wp-admin-theme-color, #3858e9))`,
		foreground: `var(--wp-components-color-foreground, #1e1e1e)`,
	},
	ui: {
		textDisabled: '#949494',
	},
...
// See `@wordpress/components/src/utils/config-values.js`.
const CONFIG = {
	radiusSmall: '2px',
};
...
export const StyledTabChildren = styled.span`
	flex-grow: 1;
...
export const StyledTabChevron = styled( Icon )`
	flex-shrink: 0;
